...
public class BrowserLanching8
{
	...
	@Test
	  public void f1() throws MalformedURLException {
			...
			System.out.println("Class 8 Method 1");
			driver.quit();
	  }
	...
	@Test
	  public void f2() throws MalformedURLException {
		...
		String title = driver.getTitle();
		System.out.println(title);
		System.out.println("Class 8 Method 2");
		driver.quit();
	  }
	...
	@Test
	  public void f3() throws MalformedURLException {
		...
		driver.get("https://www.google.co.in/");
		String title = driver.getTitle();
		System.out.println("Class 8 Method 3");
		System.out.println(title);
		driver.quit();
	  }
	...
	@Test
	  public void f4() throws MalformedURLException {
		...
		String title = driver.getTitle();
		System.out.println(title);
		System.out.println("Class 8 Method 4");
		driver.quit();
	  }
	...
	@Test
	  public void f5() throws MalformedURLException {
		...
		String title = driver.getTitle();
		System.out.println(title);
		System.out.println("Class 8 Method 5");
		driver.quit();
	  }
	...
	@Test
	  public void f6() throws MalformedURLException {
		...
		String title = driver.getTitle();
		System.out.println(title);
		System.out.println("Class 8 Method 6");
		driver.quit();	  }
