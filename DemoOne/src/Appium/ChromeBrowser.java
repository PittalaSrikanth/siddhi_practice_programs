...
//			driver.getKeyboard();
			...
			Thread.sleep(5000);
			while (!driver.findElement(By.cssSelector("div[class$='month--hasMonthDropdown']")).getText()
					.equals("September 2020")) {
				System.out
						.println(driver.findElement(By.cssSelector("div[class$='month--hasMonthDropdown']")).getText());
